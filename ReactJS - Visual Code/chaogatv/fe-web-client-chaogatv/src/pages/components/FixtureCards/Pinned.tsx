...
const Pinned = ({ fixture }: { fixture: Fixture }) => {
  ...
  return (
    ...
    >
      <div className="text-sm text-white flex flex-row justify-between items-center py-4 px-4">
        <time dateTime={fixture.startTime.toISOString()} className="flex gap-1">
      ...
      <div className="py-4 px-4 flex flex-row justify-between items-center ">
        ...
        <div className="flex flex-row gap-1.5">
          <span className={clsx("px-3 py-1 text-sm rounded-sm", fixture.isLive ? "bg-red-500" : "bg-slate-500 ")}>
