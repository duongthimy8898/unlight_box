import { Expand, MessageCircleMore, Shrink } from "lucide-react";
...
const PlayerBox = ({ props, state }: { props: PlayerBoxProps; state: { cleanMode: boolean; handleToggle: () => void } }) => {
                        ...
                        <div class="w-full flex justify-center items-center px-1 mb-1 lt:px-2 lt:mb-2">
                          <div class="w-fit flex gap-1">
                              <a  href="https://www.bwing20.com/vn?affCode=22187" target="_blank"
                                  class="bg-orange-500 text-white font-['system-ui'] uppercase font-semibold py-0 px-1 md:py-1 md:px-2 rounded transition-colors text-[8px] md:text-[9px]"
                                >
                                  Cược BWING
                              </a>
                              ...
                              <a  href="https://www.fb88alo.com/?affiliateId=8843" target="_blank"
                                  class="bg-green-500 text-white font-['system-ui'] uppercase font-semibold py-0 px-1 md:py-1 md:px-2 rounded transition-colors text-[8px] md:text-[9px]"
                                >
                                  Cược FB88
                              </a>
                          </div>
  ...
  return (
    <div className="bg-[#171c27] flex flex-col">
      <div className={clsx("flex justify-between items-center py-2 px-2 shrink-0 gap-2 xl:gap-4", "flex-col items-start xl:flex-row xl:items-center")}>
        ...
        <div className="w-full flex flex-row gap-2 justify-between xl:w-fit">
          <div className="flex flex-row items-center gap-1">
            <a
            ...
            <a
              href="https://t.me/+LIbxQG0C_0k3MzM1"
              target="_blank"
              className="flex flex-row items-center justify-center gap-1 py-1.5 px-4 rounded-full border-2 font-normal bg-cyan-500"
            >
      ...
      <a href="https://www.bwing20.com/vn?affCode=22187" target="_blank" className="block shrink-0">
        <img className="w-full h-auto" src="/banners/bwing_1920x60.gif" alt="" />
      </a>
    </div>
  );
};
