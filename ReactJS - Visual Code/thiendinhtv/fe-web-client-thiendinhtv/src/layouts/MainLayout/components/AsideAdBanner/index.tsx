...
const AsideAdBanner = () => {
  return (
    <>
      {/* Banner trái */}
      <div className="hidden bs:flex bs:flex-col fixed top-[100px] bs:left-[calc(50%+64px-830px-120px)]">
      ...
      {/* Banner phải */}
      <div className="hidden bs:flex bs:flex-col fixed top-[100px] z-50 bs:right-[calc(50%-64px-830px-120px)]">
        {adBanners.ASIDE.map((banner, idx) => (
          <a key={idx} href={banner.href} target="_blank" className="block pointer-events-auto">
            <img src={banner.src} alt="" className="block" />
          </a>
