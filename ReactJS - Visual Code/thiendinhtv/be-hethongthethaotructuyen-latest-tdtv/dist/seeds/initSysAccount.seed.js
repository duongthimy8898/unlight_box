...
async function initSysAccount() {
    ...
    const hashedPassword = await bcryptjs_1.default.hash(process.env.ADMIN_PASSWORD || "sys_ad@thiendinh.tv!8964", 10);
    const admin = repositories_1.internalUserRepo.create({
        username: process.env.ADMIN_USERNAME || "sys_ad",
        email: process.env.ADMIN_EMAIL || "sys_ad@thiendinh.tv",
        name: "Sys Admin",
