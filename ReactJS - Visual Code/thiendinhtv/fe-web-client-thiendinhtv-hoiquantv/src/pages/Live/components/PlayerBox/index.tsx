...
import { FaArrowsLeftRightToLine, FaFacebook, FaSackDollar } from "react-icons/fa6";
      ...
      if (props.status === "READY") {
        artRef.current = new Artplayer({
              ...
              html: `
                      <div id="video-overlay-bottom" style="width:100%;overflow:hidden;position:relative;">
                        <div class="w-full flex justify-between items-end px-1 mb-1 lt:px-2 lt:mb-2">
                          ...
                          <img style="display:none;" src="${adBanners.OVERLAY_VIDEO.CORNER.src}"
          ...
          plugins: [
            ...
            //   // 广告跳转网址，为空则不跳转
            //   url: "https://www.sv368cpc1.vip/register?affiliateCode=footballsv368",
    ...
    <div className="w-full h-full flex flex-col">
      <div className="w-full bg-[#1a2333]/0 gap-2 px-2 py-2 flex justify-between items-center">
          ...
          {props.broadcasts?.map((b, idx) => (
            <Link
              ...
              className={clsx(
                ...
                b.commentator.id === currentBroadcast?.commentator.id ? "bg-[#e2fe35]/50" : "bg-gray-500/25"
              )}
            >
        ...
        <button
          ...
          onClick={() => {
            window.open("https://www.facebook.com/profile.php?id=61574199330740", "_blank");
          }}
        >
          <FaFacebook size={20} />
      ...
      <div className="w-full bg-[#e2fe35]/0 px-2 py-2 flex justify-between items-center gap-2">
          ...
          {currentBroadcast?.streams?.map((s, idx) => (
            <button
              ...
              className={clsx(
                ...
                serverId === s.id.toString() ? "bg-[#e2fe35]/20 text-[#e2fe35] opacity-100" : "bg-white/20 text-white outline-transparent opacity-80"
              )}
            >
              {s.name}
            </button>
        ...
        <div className="flex items-center justify-end gap-1 lt:gap-2">
          <a
            href="https://www.sv368cpc1.vip/register?affiliateCode=footballsv368"
            target="_blank"
        ...
        <button
          ...
          className="py-1 px-2 flex space-x-1 bg-transparent border border-slate-500 rounded"
        >
