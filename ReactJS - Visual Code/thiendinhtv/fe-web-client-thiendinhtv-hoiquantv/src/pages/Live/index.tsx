...
const LivePage = () => {
  ...
  return (
    <>
      ...
      <HeroAdBanners />
      <div className="my-4"></div>
      <div className="flex w-full max-w-[1660px] mx-auto flex-col lt:flex-row items-stretch gap-0 lt:gap-4">
        ...
        <div className="w-full lt:w-[360px] dt:w-[400px] bs:w-[450px] h-[500px] lt:h-auto bg-gradient-to-b from-transparent to-[#3E3D3A] rounded-t-0 rounded-b-[8px] overflow-hidden flex-shrink-0">
          <InteractBox referenceId={fixture?.referenceId} chatChannelKeyId={fixture?.chatChannelKeyId} />
        </div>
      </div>
      <>
        {/* top nha cai */}
