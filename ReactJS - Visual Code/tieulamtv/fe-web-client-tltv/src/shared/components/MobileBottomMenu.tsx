...
const MobileBottomMenu = () => {
  return (
    <section className="lg:hidden z-50 fixed bottom-0 right-0 left-0 h-13 flex flex-row items-center bg-[#010510]">
      <Link to={"/trang-chu"} className="flex-1 flex flex-col justify-center items-center gap-0.5 text-white">
        <svg
          stroke="currentColor"
          fill="currentColor"
          strokeWidth="0"
        ...
        <span className="font-semibold text-[10px] uppercase">Trang chủ</span>
      </Link>
      <Link to={"/lich-thi-dau"} className="flex-1 flex flex-col justify-center items-center gap-0.5 text-white">
        <svg
          stroke="currentColor"
          fill="currentColor"
          strokeWidth="0"
        ...
        <span className="font-semibold text-[10px] uppercase">Lịch thi đấu</span>
      </Link>
      <Link to={"/top-nha-cai"} className="flex-1 flex flex-col justify-center items-center gap-0.5 text-white">
        <svg
          stroke="currentColor"
          fill="currentColor"
          strokeWidth="0"
        ...
        <span className="font-semibold text-[10px] uppercase">Top nhà cái</span>
      </Link>
    </section>
  );
};
