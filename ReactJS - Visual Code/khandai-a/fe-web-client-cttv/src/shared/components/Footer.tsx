...
export function Footer() {
  return (
    <footer className="mt-4 bg-[#191919] border-t border-[#2a2a2e] px-5 pt-6 pb-4 shrink-0">
      <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row justify-center lg:justify-between gap-6">
        <div>
          <p className="text-[14px] font-bold mb-1.5 w-fit bg-linear-to-r from-[#0084ff] to-[#FFC107] bg-clip-text text-transparent">CẦUTHỦTV.LIVE</p>
          <p className="text-[12px] text-zinc-600 leading-relaxed max-w-100">Xem trực tiếp bóng đá miễn phí, chất lượng Full HD.</p>
        </div>
        <div className="flex gap-2 justify-between sm:gap-5 md:gap-10">
          {footerLinks.map((col) => (
            <div key={col.title}>
      ...
      <div className="max-w-5xl mx-auto mt-4 pt-4 border-t border-[#1f1f22] flex justify-between items-center">
        <span className="text-[12px] text-zinc-700">© 2026 Cầu Thủ TV. Bảo lưu mọi quyền.</span>
