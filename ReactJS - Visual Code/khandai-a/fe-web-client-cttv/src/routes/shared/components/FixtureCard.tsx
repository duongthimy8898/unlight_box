  ...
  return (
    <Link
      ...
      className={clsx(
        ...
        "bg-linear-to-r from-[#0084ff66]/0 via-[#0084ff66]/80 to-[#0084ff66]/0",
        "border border-[#0084ff66]/40",
        "rounded-lg overflow-hidden",
        "hover:border-[#0084ff]/80 active:border-[#0084ff]/80",
    ...
    >
      <div className="flex flex-col bg-[#191919]">
        <div className="flex flex-row justify-between items-center p-4">
          <time dateTime={fixture.startTime.toISOString()} className="w-1/3 flex flex-row justify-start items-stretch gap-1">
            ...
            <span className="inline-block bg-linear-to-b from-[#FFFFFF]/0 via-[#FFC107] to-[#FFFFFF]/0 w-0.5"></span>
      ...
      <div className="grid grid-cols-[1fr_auto_1fr] bg-[#191919] pb-4">
        ...
        <div className="flex flex-col items-center justify-center gap-2">
          ...
          <p className="bg-[#000000]/50 border-x border-[#FFC107] rounded-full px-4 flex flex-row items-center gap-2">
            {fixture.isLive ? (
              <>
      ...
      <div className="flex flex-row justify-between p-2 bg-[#0F0F0F] bg-clip-padding border-t border-t-transparent">
        <div className="flex flex-row items-center bg-yellow-500 rounded-full">
          <img src={fixture.fixtureCommentators.at(0)?.commentator.avatarUrl} alt="" className="size-8 border border-white rounded-full" />
          <span className="text-black font-semibold text-sm px-2">{fixture.fixtureCommentators.at(0)?.commentator.nickname}</span>
        </div>
        <div className="flex flex-row items-center gap-2">
          ...
          <button
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
              window.open(`https://www.olabet.today/register?affiliateCode=khandaia`, "_blank");
            }}
            style={{
