  ...
  return (
    <div className={clsx("bg-transparent w-full flex flex-col overflow-hidden", "h-120 lg:h-full shrink-0 lg:flex-1", isClientViewMode && "flex-1!")}>
      <div className={clsx("w-full flex flex-col", isClientViewMode ? "hidden!" : "block")}>
        <a className="block w-full aspect-480/45" href="https://www.olabet.today/register?affiliateCode=khandaia" target="_blank">
        ...
        {[
          ...
          <button
            ...
            className={`py-1.5 rounded text-xs font-medium flex items-center justify-center transition-all duration-200 hover:opacity-100 overflow-hidden
              ${
                activeTab === tab.id
                  ? "bg-blue-500 text-black px-4 gap-1 opacity-100 w-fit max-w-96 h-7"
          ...
          <div className={clsx("w-full h-full bg-[#1e2021] flex flex-col")}>
            <div className="flex-1 flex flex-col relative">
              {/* <div className="flex">
                <button
                  ...
                  className={clsx(
                    ...
                    chatMode === "global" ? "border-blue-500 text-blue-500" : "border-white opacity-80",
                  )}
                >
                  Chung
                </button>
                <button
                  ...
                  className={clsx(
                    "flex-1 py-1.5 px-3 text-xs font-semibold border-b-2",
                    chatMode === "local" ? "border-blue-500 text-blue-500" : "border-white opacity-80",
                  )}
                >
                  Riêng
                </button>
              ...
              <div className="h-full" style={{ display: chatMode === "global" ? "block" : "none" }}>
                <iframe width="100%" height="100%" src="hhttps://www5.cbox.ws/box/?boxid=963161&boxtag=LUDzOT"></iframe>
              </div>
