...
const PlayerBox = ({ props, state }: { props: PlayerBoxProps; state: { cleanMode: boolean; handleToggle: () => void } }) => {
  ...
  return (
    <div className="bg-[#0F0F0F] flex flex-col">
      ...
      >
        <div className="flex-1 min-w-0 flex flex-row items-center gap-1">
          ...
          <div className="w-full flex flex-col overflow-hidden">
            ...
            <p className="text-xs text-yellow-500 font-semibold">{props.broadcasts?.at(0)?.commentator.nickname}</p>
          </div>
        </div>
        <div className="w-fit shrink-0 flex flex-row gap-2 justify-end">
          <div className="flex flex-row items-center gap-1">
            ...
            <a
              ...
              target="_blank"
              className="flex flex-row items-center justify-center gap-1 pr-3 rounded-full font-semibold bg-cyan-500"
            >
      ...
      <a href="https://www.olabet.today/register?affiliateCode=khandaia" target="_blank" className="block shrink-0">
