    ...
    <section className="mt-4">
        ...
        {filterOptions.map((fo, idx) => (
          <li
            ...
            className={clsx(
              ...
              "first:hover:bg-red-500 hover:bg-[#0084ff85] first:active:bg-red-500 active:bg-[#0084ff85]",
      ...
      <ul className="flex flex-col gap-2">
        {leaguesFixturesMap.map((lf, idx) => (
          <li key={idx}>
            <div className="p-2 bg-[#0084ff85] rounded-t">{lf.name}</div>
                    ...
                    >
                      <div className={clsx("flex gap-1.5", "flex-row justify-between xl:flex-col xl:justify-start")}>
                        <p className="flex flex-row items-center gap-1">
                          ...
                          <span className="bg-[#FFC107] h-4 w-px"></span>
                      ...
                      <div className="grid grid-cols-[1fr_auto_1fr] gap-4">
                        ...
                        <div className="flex flex-col justify-center items-center gap-2">
                          ...
                          <div className="bg-linear-to-b from-[#FFC107]/0 via-[#FFC107] to-[#FFC107]/0 px-0.5 rounded-md overflow-hidden">
