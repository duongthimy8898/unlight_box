            ...
            <div key={field.key} className="flex flex-col w-full gap-1">
              ...
              <div className="flex flex-row gap-2">
                <div className="relative flex-1 bg-white/15 h-[10px]">
                  <div className={clsx("absolute inset-y-0 right-0 bg-[#080247]", "transition")} style={{ width: `${homePercent}%` }}></div>
                </div>
                <div className="relative flex-1 bg-white/15 h-[10px]">
                  <div className={clsx("absolute inset-y-0 left-0 bg-[#F8C32F]", "transition")} style={{ width: `${awayPercent}%` }}></div>
                </div>
              </div>
            </div>
          );
