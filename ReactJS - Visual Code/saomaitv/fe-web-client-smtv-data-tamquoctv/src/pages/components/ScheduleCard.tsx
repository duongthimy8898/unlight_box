  ...
  return (
    ...
    >
      <div className={clsx("flex gap-1.5", "flex-row justify-between xl:flex-col xl:justify-start")}>
        ...
        <p className="text-sm font-semibold">{fixture.tournamentName}</p>
      </div>
      <div className="grid grid-cols-[1fr_auto_1fr] gap-4">
        <div className={clsx("flex gap-2 items-center justify-center overflow-hidden", "flex-col xl:flex-row-reverse")}>
          <img src={fixture.homeClub.logoUrl} alt="" className="w-12 h-12 object-contain" />
          <p className={clsx("w-full text-sm truncate", "text-center xl:text-end")}>{fixture.homeClub.name}</p>
        </div>
        ...
        <div className={clsx("flex gap-2 items-center justify-center overflow-hidden", "flex-col xl:flex-row")}>
          <img src={fixture.awayClub.logoUrl} alt="" className="w-12 h-12 object-contain" />
          <p className={clsx("w-full text-sm truncate", "text-center xl:text-start")}>{fixture.awayClub.name}</p>
        </div>
      </div>
