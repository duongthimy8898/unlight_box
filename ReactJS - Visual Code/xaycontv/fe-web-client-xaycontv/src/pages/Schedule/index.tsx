  ...
  return (
    <>
      ...
      <div className="w-full min-h-screen">
        <div className="flex flex-row space-x-2 dt:mt-0 items-center justify-start mb-4">
          <img src={pageSport?.iconUrl} alt="" className="w-6 h-6 lt:w-8 lt:h-8" />
          <span className="text-[18px] lt:text-[20px] font-semibold">Tâm điểm {pageSport?.name}</span>
        </div>
        <div className="my-1 lt:my-4"></div>
        <HeroAdBanners />
        <div className="my-1 lt:my-4"></div>
