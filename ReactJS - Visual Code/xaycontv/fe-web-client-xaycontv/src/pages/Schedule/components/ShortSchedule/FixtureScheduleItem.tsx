          ...
          <div className="w-auto flex flex-col gap-1 items-center justify-center">
            {fixture.isLive ? (
              <div className="flex flex-col gap-2 items-center justify-center">
                <span className="py-0.5 px-1.5 text-xs font-bold border border-gray-500 rounded">KXD</span>
                <div className="border-2 border-red-500 rounded-[12px] px-4 py-0.5 space-x-1">
                  <b className="text-[14px] font-bold">{fixture.score?.home}</b>
                  <span className="text-[14px] font-bold">-</span>
                  <b className="text-[14px] font-bold">{fixture.score?.away}</b>
                </div>
                <p className="font-semibold text-xs">{"---"}'</p>
              </div>
            ) : (
              <div className="border-2 border-gray-500 rounded-[12px] px-3 py-0.5">
                <span className="text-[12px] font-bold">VS</span>
              </div>
            )}
          </div>
