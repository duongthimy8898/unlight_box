    ...
    <>
      ...
      <div className="w-full min-h-screen">
        <div className="flex flex-row space-x-2 items-center justify-start mb-4">
          ...
          <span className="text-[18px] font-semibold">Xem lại {pageSport?.name}</span>
        </div>
        <div className="my-1 lt:my-4"></div>
        <HeroAdBanners />
        <div className="my-1 lt:my-4"></div>
        <div className="w-full flex flex-row justify-center gap-2">
          <input
            ...
            className="flex-1 max-w-[480px] bg-white/20 rounded px-2 py-2 outline-none focus:ring-2 focus:ring-yellow-300 text-sm"
          />
          <button type="button" className="bg-yellow-300 text-black text-sm font-semibold rounded px-4 py-2">
            Tìm kiếm
          </button>
        </div>
        <div className="my-1 lt:my-4"></div>
