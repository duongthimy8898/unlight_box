    ...
    <>
      ...
      <div className="w-full">
        <div className="flex flex-row space-x-1 items-center justify-start mb-4">
          <RiFocus2Line size={32} color="#EAB308" />
        ...
        {sports.data
          ...
          .map((sport, idx) => (
            <React.Fragment key={idx}>
              ...
              />
              {/* banner moi section */}
              {adBanners.SPORT_SECTION.length > 0 && (
                <div className="w-full flex justify-center">
                  <a
                    href={(adBanners.SPORT_SECTION[idx % adBanners.SPORT_SECTION.length] as AdBanner).href}
                    target="_blank"
                    className="w-full max-w-[720px] aspect-[1152/100]"
                  >
                    <img src={(adBanners.SPORT_SECTION[idx % adBanners.SPORT_SECTION.length] as AdBanner).src} alt="" className="w-full aspect-[1152/100]" />
                  </a>
                </div>
              )}
              {(idx + 1) % 2 === 0 && (
